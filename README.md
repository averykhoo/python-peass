...
The actual thresholds live in `tests/regression/test_matlab_regression.py`: correlation above $0.999$ for the NumPy
backend and $0.99$ for PyTorch, plus an RMS gain check against the locked resampler offset.
