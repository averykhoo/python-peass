...
agree with each other to 5e-10 correlation across the whole measured history — while CUDA, never measured against
these WAVs, keeps a documented loose bound instead of inheriting them. There is also an RMS gain check against the
