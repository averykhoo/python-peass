...
%   Signals must be stored in .wav files. Mono and stereo signals are allowed.
%
% Output:
...
%            res.qTargetPSMt, res.qInterfPSMt, res.qArtifPSMt,
%            res.qGlobalPSMt: audio quality features.
%
% See also: 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[res.qTarget, res.qInterf, res.qArtif, res.qGlobal, res.qTargetPSMt,...
    res.qInterfPSMt, res.qArtifPSMt, res.qGlobalPSMt] = ...
    audioQualityFeatures(res.decompositionFilenames,options);
