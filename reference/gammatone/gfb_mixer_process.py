"""Weighted sum of the bands, using the mixer's gain factors.

Transcribed from MATLAB PEASS v2.0.1.
"""
MATLAB_SOURCE = "gammatone/Gfb_Mixer_process.m"
...
# <<< MATLAB
def Gfb_Mixer_process(mixer, input):
    # MATLAB structs are values.  The mixer is not modified at all here, but it
    # is still returned by value, so hand back a copy.
    mixer = mixer.copy()
...
# <<< MATLAB
    output = mixer.gains @ input  # MATLAB * is a matrix product here
