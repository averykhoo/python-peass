...
def extract_distortion_components(
    ...
    res = decompose_distortion_components(
    ...
    file_paths = []
    if res.file_paths is not None:
        file_paths = [
            res.file_paths.true_target,
            res.file_paths.target_distortion,
            res.file_paths.interference,
            res.file_paths.artifacts
        ]

    waveforms = [
        res.waveforms.true_target,
        res.waveforms.target_distortion,
        res.waveforms.interference,
        res.waveforms.artifacts
    ]

    return file_paths, waveforms